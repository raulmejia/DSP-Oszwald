...
### Example  
Rscript /path/Differential_expression_hybridized-n-scanned-Data-trough-limma.R /other/path/yourExpressionMatrix.tsv /path2/annotation_Table.tsv /path2/the-code-this-script-n-its-libraries/ /media/rmejia/mountme88/Projects/DSP/Results/DEG/Protein/ label 0 0.05 Andre_GeoMx_Protein_DEG
