...
### Example  
```Rscript /path/Differential_expression_hybridized-n-scanned-Data-trough-limma.R /other/path/yourExpressionMatrix.tsv /path2/toyannot.tsv /path2/the-code-this-script-n-its-libraries/ /path/results name_of_the_column_in_your_Annot_Table_that_contain_the_classes 0 0.05 some_label_4_your_results```
